...
@Controller
public class ProcessOwnController {
    @Autowired
    ...
    private static Logger logger = LoggerFactory.getLogger(ProcessOwnController.class);
    ...
    public void getFlowImgByInstantId(HttpServletRequest request, HttpServletResponse response) {
